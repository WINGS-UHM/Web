...
description: "Introducing Course Pages and Landing Pages for WINGS Lab"
...
I really like Jekyll as it is simple to use, but also very powerful. I decided to make the most of the frontmatter and allow you to set most of the course information in there, leaving the main content of the page for the text description. 
...
The features provides a way of making a bullet point list of the key course features, but instead of plain disc bullet points you can use font awesome icons to make it a bit more interesting. 

I don’t know about you, but sometimes I spend longer deciding on what icon to use than making the rest of the page. 

I’ve deliberately made the course pages have a 4 by 3 image ratio as I feel it works best across different screen sizes. Like all themes, if you want to change it you can override the default layouts if you want a different ratio. 

Once you have created your course pages, you will need to tell Jekyll to output them. This is done by adding collections settings in the `_config.yml` for your site. 
...
Now when you run jekyll build it will output a load of course pages for you, now we just need a way of getting to them. This is where the course category page comes in. 

## Course Category

Create a page, such as courses.md or in my case books.md and set it to use the course-category layout. This will generate a list of the courses, but you can also add some introduction content in the main content section of the page if you so desire. 
...
This is some page content and it will appear above the course list.
```

## Course Reviews

The last addition to the course pages is reviews. If you would like to list some customer reviews on your course pages, then you will need to create a reviews directory inside _data and create a separate file for each course with reviews, named after the course code. For example `_data/reviews/ABC124.yml`
...
- name: Mr E Xample
  ...
  description: >
    The course worked really well. I would recommend this to most people to use. Delivery was quick and reasonable. 
...
- name: Mrs R E View
  ...
  date: 02/02/2019
  description: >
    The course worked exactly as described.
```

Example [course category and course pages](https://www.csrhymes.com/bulma-clean-theme/courses/) can be seen on the theme’s demo site here if you want to take a look. 
